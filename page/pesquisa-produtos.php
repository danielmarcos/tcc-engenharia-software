<?php
$getTermo = $_GET['termo'];
$produtos = $pdo->query("select top 20 * from dbo.produtos where produto like '%$getTermo%'")->fetchAll(); ?>
    ...
    <div class="row g-4 justify-content-center">
        ...
        <?php foreach ($produtos as $produto): ?>
            <div class="col-md-6 col-lg-6 col-xl-4">
                <a href="?p=produto&g=<?php echo($produto['idproduto']); ?>&termo=<?php echo($getTermo); ?>">
